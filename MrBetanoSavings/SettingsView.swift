        ...
        VStack {
           ...
           Rectangle()
            ...
            Rectangle()
                 ...
                 .padding(.horizontal)
                 .onTapGesture {
                     openURL(URL(string: "https://www.dropbox.com/scl/fi/me9ewefd0u35ebltmkfdl/Privacy-Policy-for-Mr-Betano-Savings.paper?rlkey=nqfnk6apvvzlgme5qv5uli56o&st=u7jkgmmg&dl=0")!)
                 }
            ...
            Rectangle()
                 ...
                 .padding(.horizontal)
                 .onTapGesture {
                     if let url = URL(string: "mailto:ngothihongcau5625@gmail.com") {
